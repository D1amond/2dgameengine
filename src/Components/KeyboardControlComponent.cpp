...
KeyboardControlComponent::KeyboardControlComponent(Entity* owner, std::string upKey, std::string rightKey, std::string downKey, std::string leftKey, std::string shootKey): Component(owner) {
